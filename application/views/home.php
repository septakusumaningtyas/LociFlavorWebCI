    ...
    <section class="home-slider owl-carousel js-fullheight">
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-12 col-sm-12 text-center ftco-animate">
              ...
              <p><a href="<?php echo base_url("reservation"); ?>" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="<?php echo base_url("menu"); ?>" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
      ...
      <div class="slider-item js-fullheight" style="background-image: url(<?php echo base_url("assets/"); ?>images/bg_2.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
      ...
      <div class="slider-item js-fullheight" style="background-image: url(<?php echo base_url("assets/"); ?>images/bg_3.jpg);">
      	<div class="overlay"></div>
        <div class="container">
		...
		<section class="ftco-section ftco-wrap-about ftco-no-pb">
			<div class="container">
	          ...
	          <div class="heading-section mb-4 text-center">
	            ...
	            <h2 class="mb-4">Loci Flavor Restaurant</h2>
	          </div>
						<p>Restaurant that serves a variety of Indonesian local flavors where the local flavors are supported by ingredients from Indonesia itself. Loci Flavor itself has a meaning that is a restaurant that provides local flavor.</p>

						<div class="video justify-content-center">
							<a href="https://www.youtube.com/watch?v=RmkutEl3NhM" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Provides delicious food that is devoted to birthday parties including birthday cakes that can be changed in design.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>
									Provides delicious food that is devoted to business meetings including snacks.</p>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Providing delicious food that is devoted to wedding party.</p>
              </div>
            </div>      
          </div>
        </div>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb">
            ...
            <h2 class="mb-4">Our Master Chef</h2>
				...
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img" style="background-image: url(<?php echo base_url("assets/"); ?>images/chef-4.jpg);"></div>
							<div class="text pt-4">
								<h3>Renatta Moeloek</h3>
								<span class="position mb-2">Restaurant Owner</span>
								<p>
									Renatta Moeloek is an Indonesian chef. Chef Renatta completed her cooking education at Le Cordon Bleu Culinary Art in Paris, France by earning a Diploma in Superior Cuisine and Superior Pastry in 2018.</p>
								<div class="faded">
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img" style="background-image: url(<?php echo base_url("assets/"); ?>images/chef-2.jpg);"></div>
							<div class="text pt-4">
								<h3>Juna Rorimpandey</h3>
								<span class="position mb-2">Head Chef</span>
								<p>Chef Juna is a celebrity chef who became famous after being a judge at the MasterChef cooking event. During his 12 years spent abroad, Juna was a chef specializing in Japanese and French cuisine.</p>
								<div class="faded">
									<!-- <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p> -->
									<ul class="ftco-social d-flex">
		                <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img" style="background-image: url(<?php echo base_url("assets/"); ?>images/chef-3.jpg);"></div>
							<div class="text pt-4">
								<h3>Arnold Poernomo</h3>
								<span class="position mb-2">Chef</span>
								<p>Arnold Poernomo or better known as Chef Arnold is a chef who became famous after being a judge on the MasterChef event. Chef Arnold was born into a family of cook lovers. The owner's full name Arnold Poernomo has entered the kitchen world since the age of 14 years.</p>
								<div class="faded">
									<!-- <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p> -->
									<ul class="ftco-social d-flex">
		                <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img" style="background-image: url(<?php echo base_url("assets/"); ?>images/chef-1.jpg);"></div>
							<div class="text pt-4">
								<h3>Rinrin Marinka</h3>
								<span class="position mb-2">Chef</span>
								<p>Maria Irene Susanto or better known by her stage name Rinrin Marinka is an Indonesian celebrity chef. Her cooking hobby has grown since elementary school. She graduated from Le Cordon Bleu, Sydney, Australia with special expertise in French Cuisine & Patisserie. She also teaches at the Pantry Magic Cooking School.</p>
								<div class="faded">
									<!-- <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p> -->
									<ul class="ftco-social d-flex">
		                <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
		...
		<!-- <section class="ftco-section testimony-section" style="background-image: url(<?php echo base_url("assets/"); ?>images/bg_5.jpg);" data-stellar-background-ratio="0.5"> -->
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap text-center pb-5">
                  ...
                  <div class="text p-3">
                    <p class="mb-4">The food is delicious and worth to try again</p>
              ...
              <div class="item">
                <div class="testimony-wrap text-center pb-5">
                  ...
                  <div class="text p-3">
                    <p class="mb-4">It feels very local with ingredients that come from Indonesia itself</p>
              ...
              <div class="item">
                <div class="testimony-wrap text-center pb-5">
                  ...
                  <div class="text p-3">
                    <p class="mb-4">The coffee that they offered has a distinctive taste.</p>
              ...
              <div class="item">
                <div class="testimony-wrap text-center pb-5">
                  <div class="user-img mb-4" style="background-image: url(<?php echo base_url("assets/"); ?>images/person_4.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text p-3">
                    <p class="mb-4">Not only food, but the drinks are also delicious.</p>
              ...
              <div class="item">
                <div class="testimony-wrap text-center pb-5">
                  ...
                  <div class="text p-3">
                    <p class="mb-4">Many kinds of food from all over Indonesia.</p>

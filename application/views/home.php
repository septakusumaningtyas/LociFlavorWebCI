        ...
        <div class="row mb-5">
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Loci Flavor</h2>
              <p>Restaurant that serves a variety of Indonesian local flavors where the local flavors are supported by ingredients from Indonesia itself. Find us on social media</p>
          ...
          <div class="col-md-6 col-lg-3">
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="thumb d-sm-flex">
	            	<a href="#" class="thumb-menu img" style="background-image: url(<?php echo base_url("assets/"); ?>images/insta-1.jpg);">
	            	</a>
	            	<a href="#" class="thumb-menu img" style="background-image: url(<?php echo base_url("assets/"); ?>images/insta-2.jpg);">
	            	</a>
	            	<a href="#" class="thumb-menu img" style="background-image: url(<?php echo base_url("assets/"); ?>images/insta-3.jpg);">
	            	</a>
	            </div>
	            <div class="thumb d-flex">
	            	<a href="#" class="thumb-menu img" style="background-image: url(<?php echo base_url("assets/"); ?>images/insta-4.jpg);">
	            	</a>
	            	<a href="#" class="thumb-menu img" style="background-image: url(<?php echo base_url("assets/"); ?>images/insta-5.jpg);">
	            	</a>
	            	<a href="#" class="thumb-menu img" style="background-image: url(<?php echo base_url("assets/"); ?>images/insta-6.jpg);">
	            	</a>
	            </div>
            </div>
          </div>
